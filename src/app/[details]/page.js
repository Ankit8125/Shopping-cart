...
async function ProductDetails({params}){ // will give us params property

    const getSession = await auth()
    if(!getSession?.user) redirect('/unauth-page')

    const getProductDetails = await fetchProductDetails(params.details) // we need to pass the id
