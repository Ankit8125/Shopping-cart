...
function Cart(){
    ...
    const [totalAmount, setTotalAmount] = useState(0) // to display the total items, we are making another 'state'
    ...
    function handleRemoveFromCart(getCurrentItemID){ // this is advantage of using redux, since we have all the states in 1 place
